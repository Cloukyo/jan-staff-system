...
function snapshot(
  overrides: Partial<OnboardingBootstrapSnapshot["security"]> = {},
  ...
  return {
    ...
    legalDocuments: [
      {
        ...
        summary: "Fictional commercial terms.",
      ...
      },
      {
        ...
        summary: "Fictional privacy information.",
        effectiveAt: "2026-08-01T00:00:00+00:00",
        accepted: false,
      },
      {
        ...
        summary: "Fictional processor terms.",
        effectiveAt: "2026-08-01T00:00:00+00:00",
        accepted: false,
      },
    ],
    ...
    staffInvitations: { skipped: false, staff: [] },
  };
}
...
describe("authoritative onboarding resume route", () => {
  it("routes every bootstrap state from server evidence", () => {
    ...
    expect(
      authoritativeOnboardingRoute(
        snapshot({ emailVerified: true, assuranceLevel: "aal2" }),
      ),
    ).toBe("/onboarding/legal");
    expect(
      authoritativeOnboardingRoute(
        snapshot({
          emailVerified: true,
    ...
    ).toBe("/onboarding/organisation");
    expect(
      authoritativeOnboardingRoute(
        snapshot({}, "72000000-0000-4000-8000-000000000002"),
      ),
    ).toBe("/onboarding/site");
    ...
    expect(authoritativeOnboardingRoute(complete)).toBe(
