...
export default async function ClockPage() {
  ...
  if (!roster) {
    return <main className="grid min-h-screen place-items-center bg-purple-950 p-6 text-white"><div className="max-w-lg text-center"><h1 className="text-3xl font-black">Kiosk access required</h1><p className="mt-4">A manager must sign in and activate this device before staff can clock in.</p><Link className="mt-6 inline-flex min-h-11 items-center rounded-lg bg-white px-5 font-bold text-purple-950" href="/login">Manager sign in</Link></div></main>;
  }
