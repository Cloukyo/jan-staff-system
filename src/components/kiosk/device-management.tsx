...
export function KioskDeviceManagement({ devices }: { devices: KioskDeviceRow[] }) {
  return <div className="grid gap-5">
    <Panel>
      <h2 className="text-xl font-black text-purple-950">Activate this browser as a kiosk</h2>
      <p className="mt-2 text-sm text-slate-600">Activation signs the manager out of this browser and restricts it to the clock screen.</p>
      <PayrollActionForm action={activateKioskDeviceAction} submitLabel="Activate this device">
    ...
    <Panel>
      <h2 className="text-xl font-black text-purple-950">Registered kiosk devices</h2>
