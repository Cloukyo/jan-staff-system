...
export const managerHelpTasks: ManagerHelpTask[] = [
  ...
  },
  {
    ...
    group: "Daily work",
    title: "Reset to planned hours",
    summary: "Remove effective attendance events and replace them with the published rota start and finish.",
    steps: [
      "Open Staff hours, choose the staff member and open the day.",
      "Choose Reset to planned hours.",
      "Check every event being removed and the planned start and finish being added.",
      "Add a reason, confirm and save the reset. Add any lunch events manually afterwards.",
    ],
    href: "/attendance?view=hours",
    shortcutLabel: "Open Staff hours",
    keywords: ["rota hours", "planned shift", "published rota", "reset planned hours"],
  },
  {
