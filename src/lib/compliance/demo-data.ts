...
export function createDemoComplianceState(profileId: IndustryProfileId = getActiveIndustryProfile().id): DemoComplianceState {
  ...
  const staff: StaffProfile[] = [
    ["staff-ejana-chowdhury-jyoti", "Ejana Chowdhury Jyoti", "Ejana", "Level 3"],
    ["staff-areeg-shahzadi", "Areeg Shahzadi", "Areeg", "Level 3"],
    ["staff-ashwathy-vijayakumar-sreelekha", "Ashwathy Vijayakumar Sreelekha", "Ashwathy", "Level 2"],
    ["staff-atampreet-kaur", "Atampreet Kaur", "Atampreet", "Level 3"],
    ["staff-fouzia-mechri", "Fouzia Mechri", "Fouzia", null],
    ["staff-haleema-sadia", "Haleema Sadia", "Haleema", "Level 3"],
    ["staff-kitenge-tshakupebwa", "Kitenge Tshakupebwa", "Kitenge", null],
    ["staff-madiha-luqman", "Madiha Luqman", "Madiha", "Level 2"],
    ["staff-nazmon-hannan", "Nazmon Hannan", "Nazmon", "Level 3"],
    ["staff-naziha-bouda", "Naziha Bouda", "Naziha", "Level 3"],
    ["staff-rehana-mahmood", "Rehana Mahmood", "Rehana M", "Level 3"],
    ["staff-rehana-ali", "Rehana Ali", "Rehana A", null],
    ["staff-samreera-siddiqah", "Samreera Siddiqah", "Samreera", "Level 3"],
    ["staff-shukri-ismail", "Shukri Ismail", "Shukri", "Level 2"],
    ["staff-mahbuba-begum-panna", "Mahbuba Begum Panna", "Mahbuba", null],
